...
namespace Gamingsolved\Paperspace\Api\Client\Version0_1_1\Model;
...
class CreatedMachineResponse implements ArrayAccess
{
    ...
    public function __toString()
    {
        if (defined('JSON_PRETTY_PRINT')) { // use JSON pretty print
            return json_encode(\Gamingsolved\Paperspace\Api\Client\Version0_1_1\ObjectSerializer::sanitizeForSerialization($this), JSON_PRETTY_PRINT);
        }

        return json_encode(\Gamingsolved\Paperspace\Api\Client\Version0_1_1\ObjectSerializer::sanitizeForSerialization($this));
    }
}
